...
exports.onCreatePage = function (_ref) {
  ...
  if (rootQuery) {
    ...
    page.context.headers = (0, _defineProperty2.default)({}, _prismic.EditButton.HEADER_NAME, page.path);
  ...
  var opts = (0, _objectSpread2.default)({
    ...
    createLink: function createLink() {
      return (0, _utils.PrismicLink)({
        uri: _prismic.Endpoints.graphql(options.repositoryName),
  ...
  edges.forEach(function (_ref3, index) {
    ...
    createPage({
      ...
      context: (0, _objectSpread2.default)({
        headers: (0, _defineProperty2.default)({}, _prismic.EditButton.HEADER_NAME, path),
