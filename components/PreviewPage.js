          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 9;
                return _prismicJavascript.default.getApi(_prismic.Endpoints.v2(this.config.repositoryName));
              ...
              case 32:
                _doc = _context2.sent;
                _preview2 = Boolean(_prismic.PreviewCookie.ref(this.config.repositoryName)) || cookies.has(_prismicJavascript.default.experimentCookie);
