...
var WrapPage = /*#__PURE__*/function (_React$PureComponent) {
  ...
  (0, _createClass2.default)(WrapPage, [{
    ...
    value: function componentDidMount() {
      ...
      var hasCookie = cookies.has(_prismicJavascript.default.experimentCookie) || Boolean(_prismic.PreviewCookie.ref(this.props.options.repositoryName));
    ...
    value: function render() {
      var props = this.props; // we need to pass the parent props to the child
      // but we don't want to pass the prismic options or the children props
      // so exclude those and take everything else

      var children = props.children,
          options = props.options,
          elProps = (0, _objectWithoutProperties2.default)(props, ["children", "options"]);
      return _react.default.cloneElement(children, (0, _objectSpread2.default)({}, elProps, children.props, {
        prismic: {
